    ...
    <div class="supplier-kpi-card">
        <div class="supplier-kpi-top">
            <div>
                ...
                <div class="supplier-kpi-value"><?php echo e($dashboard['total_suppliers'] ?? 0); ?></div>
            </div>
    ...
    <div class="supplier-kpi-card">
        <div class="supplier-kpi-top">
            <div>
                ...
                <div class="supplier-kpi-value"><?php echo e($dashboard['visible_active_count'] ?? 0); ?></div>
            </div>
    ...
    <div class="supplier-kpi-card">
        <div class="supplier-kpi-top">
            <div>
                ...
                <div class="supplier-kpi-value"><?php echo e($dashboard['visible_inactive_count'] ?? 0); ?></div>
            </div>
    ...
    <div class="supplier-kpi-card">
        <div class="supplier-kpi-top">
            <div>
                ...
                <div class="supplier-kpi-value"><?php echo e($dashboard['categories_count'] ?? 0); ?>/<?php echo e($dashboard['payment_modes_count'] ?? 0); ?></div>
            </div>
...
<div class="supplier-grid-2">
    <div class="supplier-analytics-card">
        ...
        <div class="supplier-bars">
            <?php if(!empty($dashboard['top_categories'] ?? [])): ?>
                <?php $__currentLoopData = ($dashboard['top_categories'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="supplier-bar-row">
                        <div class="supplier-bar-label"><?php echo e($label); ?></div>
                        <div class="supplier-bar-track">
                            <div
                                class="supplier-bar-fill"
                                style="width: <?php echo e(max(($dashboard['top_categories'] ?? [1])) > 0
                                        ? (($value / max(($dashboard['top_categories'] ?? [1]))) * 100)
                                        : 0); ?>%;"
                            ></div>
                        </div>
                        <div class="supplier-bar-value"><?php echo e($value); ?></div>
                    </div>
    ...
    <div class="supplier-analytics-card">
        ...
        <div class="supplier-bars">
            <?php if(!empty($dashboard['tier_breakdown'] ?? [])): ?>
                <?php $__currentLoopData = ($dashboard['tier_breakdown'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="supplier-bar-row">
                        <div class="supplier-bar-label"><?php echo e($label); ?></div>
                        <div class="supplier-bar-track">
                            <div
                                class="supplier-bar-fill"
                                style="width: <?php echo e(max(($dashboard['tier_breakdown'] ?? [1])) > 0
...
<div class="panel">
    <div class="panel-toolbar">
        <form method="GET" class="toolbar-grid two-rows">
            ...
            <select class="field-select" name="category">
                ...
                <?php $__currentLoopData = $configLists['supplier_categories'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" <?php if(($filters['category'] ?? '') === $value): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            ...
            <select class="field-select" name="third_party_type">
                ...
                <?php $__currentLoopData = $configLists['tier_types'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" <?php if(($filters['third_party_type'] ?? '') === $value): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            ...
            <select class="field-select" name="payment_mode">
                ...
                <?php $__currentLoopData = $configLists['supplier_payment_modes'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" <?php if(($filters['payment_mode'] ?? '') === $value): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>

            <select class="field-select" name="is_active">
                <option value="">Actifs + inactifs</option>
                <option value="1" <?php if(($filters['is_active'] ?? '') === '1'): echo 'selected'; endif; ?>>Actifs</option>
                <option value="0" <?php if(($filters['is_active'] ?? '') === '0'): echo 'selected'; endif; ?>>Inactifs</option>
            </select>
        ...
        <div class="supplier-table-tools">
            ...
            <div class="toolbar-right">
                ...
                <a href="<?php echo e(route('options.index')); ?>" class="btn btn-light">
    ...
    <div class="table-meta">
        <div>
            <strong><?php echo e($suppliers->firstItem() ?? 0); ?></strong>
            à
            <strong><?php echo e($suppliers->lastItem() ?? 0); ?></strong>
            sur
            <strong><?php echo e($suppliers->total()); ?></strong>
            fournisseurs
        </div>

        <div>
            Colonnes visibles :
            <strong><?php echo e(count($activeColumns ?? [])); ?></strong>
        </div>
    </div>
    ...
    <tr>
        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <th data-column="<?php echo e($key); ?>">
                <a href="<?php echo e(route('suppliers.index', array_merge(request()->query(), [
                    'sort_by' => $key,
                    'sort_direction' => (($sortBy === $key && $sortDirection === 'asc') ? 'desc' : 'asc')
                ]))); ?>"
                   class="supplier-sort-link <?php echo e($sortBy === $key ? 'active' : 'dim'); ?>">
                    <span><?php echo e($label); ?></span>

                    <?php if($sortBy === $key && $sortDirection === 'asc'): ?>
                        <i data-lucide="arrow-up"></i>
                    <?php elseif($sortBy === $key && $sortDirection === 'desc'): ?>
        ...
        <th class="actions-col">Actions</th>
                ...
                <tbody>
                            ...
                            <td class="actions-col">
                                <div class="table-actions">
                                    <button
                                        ...
                                        data-category="<?php echo e($supplier->category); ?>"
                                        data-tier="<?php echo e($supplier->third_party_type); ?>"
                                        data-budget="<?php echo e($supplier->budget_category); ?>"
                                        data-payment="<?php echo e($supplier->payment_mode); ?>"
                                        data-frequency="<?php echo e($supplier->frequency); ?>"
                                        data-email="<?php echo e($supplier->email); ?>"
                                        data-phone="<?php echo e($supplier->phone); ?>"
                                        data-delay="<?php echo e($supplier->payment_delay_days); ?>"
                                        data-active="<?php echo e($supplier->is_active ? 'Oui' : 'Non'); ?>"
                                    >
                                        <i data-lucide="eye"></i>
                                    </button>

                                    <a href="<?php echo e(route('suppliers.edit', $supplier)); ?>" class="btn btn-light btn-sm">
                                        <i data-lucide="pencil"></i>
                                    </a>

                                    <form method="POST" action="<?php echo e(route('suppliers.destroy', $supplier)); ?>" onsubmit="return confirm('Supprimer ce fournisseur ?');">
                                        <?php echo csrf_field(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e(count($columns) + 1); ?>" class="empty-state">Aucun fournisseur trouvé.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
        ...
        <div class="check-grid">
            <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <label class="check-tile">
                    <input type="checkbox" class="js-column-toggle" value="<?php echo e($key); ?>" <?php if(in_array($key, $activeColumns ?? [], true)): echo 'checked'; endif; ?>>
                    <span><?php echo e($label); ?></span>
                </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<div class="modal" id="supplierDetailModal">
    ...
    <div class="modal-panel sm">
        ...
        <div class="list-card supplier-modal-grid-2">
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Code</div><div class="list-row-subtitle" id="detail-code">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Raison sociale</div><div class="list-row-subtitle" id="detail-name">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Catégorie</div><div class="list-row-subtitle" id="detail-category">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Type tiers</div><div class="list-row-subtitle" id="detail-tier">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Catégorie budgétaire</div><div class="list-row-subtitle" id="detail-budget">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Mode règlement</div><div class="list-row-subtitle" id="detail-payment">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Fréquence</div><div class="list-row-subtitle" id="detail-frequency">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Email</div><div class="list-row-subtitle" id="detail-email">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Téléphone</div><div class="list-row-subtitle" id="detail-phone">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Délai paiement</div><div class="list-row-subtitle" id="detail-delay">-</div></div></div>
            <div class="list-row"><div class="list-row-main"><div class="list-row-title">Actif</div><div class="list-row-subtitle" id="detail-active">-</div></div></div>
        </div>
...
<script>
const defaultColumns = <?php echo json_encode($columnDefaults ?? [], 15, 512) ?>;
const initialColumns = <?php echo json_encode($activeColumns ?? [], 15, 512) ?>;
...
if (saveColumnsBtn) {
    saveColumnsBtn.addEventListener('click', async () => {
        ...
        await fetch('<?php echo e(route('suppliers.save-columns')); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\dev\erp-finance\resources\views/suppliers/index.blade.php ENDPATH**/ ?>