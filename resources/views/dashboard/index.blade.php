...
<div class="kpi-strip">
    ...
    <div class="kpi-card">
        <h4>Dépenses</h4>
        <div class="value">{{ $expenseCount ?? 0 }}</div>
        <div class="meta">Flux enregistrés</div>
    </div>

    <div class="kpi-card">
        <h4>Budget total</h4>
        <div class="value">{{ isset($budgetTotal) ? number_format($budgetTotal, 0, ',', ' ') : '0' }}</div>
...
<div class="grid-2">
    <div class="mini-panel">
        ...
        <div class="grid-2">
            <a href="{{ route('suppliers.index') }}" class="check-tile" style="justify-content:space-between;">
                <span>Référentiel fournisseurs</span>
                <i data-lucide="arrow-right"></i>
            </a>

            <a href="{{ route('expenses.index') }}" class="check-tile" style="justify-content:space-between;">
                <span>Dépenses</span>
                <i data-lucide="arrow-right"></i>
            </a>

            <a href="{{ route('budgets.index') }}" class="check-tile" style="justify-content:space-between;">
                <span>Budgets</span>
                <i data-lucide="arrow-right"></i>
            </a>

            <a href="{{ route('treasury.index') }}" class="check-tile" style="justify-content:space-between;">
