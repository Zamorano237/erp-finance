    ...
    <div class="app-shell">
        <aside class="sidebar" id="appSidebar">
            ...
            <nav class="nav-section">
                ...
                <a class="nav-link {{ $hasTreasury && request()->routeIs('treasury.*') ? 'active' : '' }} {{ !$hasTreasury ? 'disabled opacity-50' : '' }}"
                    href="{{ $hasTreasury ? route('treasury.index') : '#' }}">

                    <span class="nav-icon-wrap"><i data-lucide="line-chart"></i></span>
                    <span class="nav-text">Trésorerie</span>
                </a>

                <a class="nav-link {{ request()->routeIs('options.*') ? 'active' : '' }}" href="{{ route('options.index') }}">
        ...
        <div class="main-shell">
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <div class="page-meta">
                        <h2>{{ $title ?? 'ERP Finance' }}</h2>
                        <p>{{ $subtitle ?? 'Pilotage ERP modulaire premium' }}</p>
                    </div>
                </div>
                ...
                <div class="topbar-right">
                    ...
                    <div class="user-chip">
                        <div class="user-chip-text">
                            <div class="user-chip-name">{{ auth()->user()->name ?? 'Admin' }}</div>
                            <div class="user-chip-role">{{ auth()->user()->role ?? 'ERP Manager' }}</div>
                        </div>
